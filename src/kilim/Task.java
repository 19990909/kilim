...
public abstract class Task implements EventSubscriber {
    ...
    public void _runExecute(WorkerThread thread, boolean resetPreferredResumeThread) throws NotPausable {
        ...
        try {
            ...
            assert this.preferredResumeThread == null || this.preferredResumeThread == thread : "Resumed " + this.id
                    + " in incorrect thread. ";
            ...
            assert this.pauseReason == null && isDone || this.pauseReason != null && !isDone : "pauseReason:"
                    + this.pauseReason + ",isDone =" + isDone;
        }
        catch (Throwable th) {
            th.printStackTrace();
            // Definitely done
        ...
        if (isDone) {
            ...
            if (thread != null) { // it is null for generators
                if (this.numActivePins > 0) {
                    ...
                    //if want to reset preferredResumeThread
